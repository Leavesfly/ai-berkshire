...
description: 行业漏斗筛选——对一个行业/方向执行漏斗式价值投资筛选，从全市场扫描逐层精选到 3 家终选标的。当用户想在某行业内筛选出最优质的少数标的、做从全市场到精选的分层筛选时使用。
type: executable
confirm_level: heavy
tools_required: [quality_screen.py, ashare_data.py, financial_rigor.py, report_audit.py]
depends_on: [financial-data, quality-screen]
---
